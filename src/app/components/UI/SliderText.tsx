...
const SliderText = () => {
  return (
    <div className="w-full flex items-center justify-center sm:justify-start px-20 z-10 absolute top-40 text-white">
      <div className="w-full sm:w-1/2 text-center sm:text-start flex-col">
        ...
        <div className="text-5xl sm:text-8xl pb-2 font-barlow-condensed font-thin">INTRODUCING</div>
